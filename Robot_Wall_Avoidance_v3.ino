...
const int LEFT_TRIG  = 31;
const int LEFT_ECHO  = 32;
...
// -------- navigation --------
void wallFollow(float left,float front){
 if(front<wallStop){ turnRight(turnspd); return; }
 if(left<leftTarget-3){ turnRight(80); }
 else if(left>leftTarget+3){ turnLeft(80); }
